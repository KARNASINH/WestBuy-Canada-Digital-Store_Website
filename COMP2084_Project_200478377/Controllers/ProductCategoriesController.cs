...
namespace COMP2084_Project_200478377.Controllers
{
    public class ProductCategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CategoryId,CategoryDescription,Aisle,ProductType,Status,Discount")] ProductCategory productCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoryId,CategoryDescription,Aisle,ProductType,Status,Discount")] ProductCategory productCategory)
        {
